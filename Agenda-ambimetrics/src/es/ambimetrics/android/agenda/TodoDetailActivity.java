...
public class TodoDetailActivity extends Activity {
  ...
  protected void onCreate(Bundle bundle) {
    ...
    mBodyText2 = (EditText) findViewById(R.id.todo_edit_description2);
  ...
  private void saveState() {
    ...
    String description2 = mBodyText2.getText().toString();
    ...
    values.put(TodoTable.COLUMN_DESCRIPTION2, description2);
